...
/* Esta es la página para Iniciar Sesión para los Clientes.
*
* Para diferenciarla de la web app para los Administradores, pondré un mensaje que diga "inicie sesión aquí si usted
* es un cliente" o algo así.
*
* */
...
const Login = () => {
  ...
  return (
    <>
      ...
      >
        {/*Esto llama al banner que imprime "Visita nuestra nueva web". DESACTIVAR, ya que no lo necesito.*/}
        {/*<AuthBanner />*/}
        <Container
          maxWidth="sm"
          sx={{
        ...
        >
          ...
          >
            ...
            >
              ...
              {/* Texto que aparece debajo del título de "Iniciar Sesión". */}
              <Typography
                color="textSecondary"
                sx={{ mt: 2 }}
                variant="body2"
              >
                Introduce email y contraseña para acceder a tu cuenta de cliente del gimnasio.
              </Typography>
            </Box>
            <Box
              sx={{
