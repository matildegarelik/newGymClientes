...
import { ServiceListTable } from '../../components/services/service-list-table';
...
const ServiceList = () => {
  ...
  const filteredCustomers = applyFilters(services, filters);
  ...
  const handleDelete = async (id) => {
    try {
      ...
      toast.success('Servicio borrado con éxito!');
      getServices()
    } catch (err) {
      console.error(err);
